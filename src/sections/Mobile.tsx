...
export default function Mobiles() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const response_data = await fetchProductsByCategory("phone");
  ...
  return (
    <section id="Mobiles" className="min-h-dvh px-4 py-8">
      <div className="bg-white shadow-md">
        <div className="container mx-auto mb-16 border z-30 px-6 py-3 flex justify-between items-center">
          ...
          <div className="md:hidden z-10">
            <button
              onClick={toggleMenu}
              className="text-gray-800 bg-red  focus:outline-none"
            >
      ...
      <div className="mobiles flex flex-col items-center sm:flex-row sm:items-start flex-wrap gap-2 pt-4">
        {items.length > 0
